...
public class rotateObject : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            myVector3 rolledVertex = (rollMatrix * ModelSpaceVertices[i]).ToMyVector3();
            myVector3 pitchedVertex = (pitchMatrix * rolledVertex).ToMyVector3();
            myVector3 yawedVertex = (yawMatrix * pitchedVertex).ToMyVector3();
