...
[ExecuteInEditMode]
public class myTransform_OLD : MonoBehaviour
{
...
/// </summary>
[CustomEditor(typeof(myTransform_OLD))]
[CanEditMultipleObjects]
public class myTransform_OLDEditor : Editor
{
   ...
   /* private void OnEnable()
    ...
    public override void OnInspectorGUI()
    {
        ...
        myTransform_OLD myTrans = (myTransform_OLD)target;
